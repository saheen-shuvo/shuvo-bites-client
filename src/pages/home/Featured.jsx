    ...
    <div className="max-w-screen-xl mx-auto px-4 my-8 lg:my-16 featured-item text-white bg-fixed">
      ...
      <div className="md:flex justify-center items-center pt-14 pb-20 lg:px-36">
        ...
        <div className="md:ml-10">
          <p>24 January, 2025</p>
          <p className="uppercase my-2 font-semibold text-lg">
            Where can i get some?
          </p>
          <p>
            Chicken Puchka is a flavorful delight featuring tender grilled
            chicken skewers marinated in aromatic spices. Juicy, smoky, and
            perfectly charred, it's served with fresh salad, warm pita, and a
